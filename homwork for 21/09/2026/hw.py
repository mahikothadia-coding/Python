...
class Transportation:
    ...
    def show_details(self):
        ...
        print("Max Speed per hour:", self.max_speed, "km/h")
...
my_car = Car("SUV", 7, "BYD (Build Your Dreams (from China))", 496.22)
...
print("Is Car a subclass of Transportation?", issubclass(Car, Transportation))
